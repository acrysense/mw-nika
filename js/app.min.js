...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var directions = Array.from(brandsCircles).map(function () {
    return {
  ...
  if (brandsCard && brandsCircles) {
    brandsCard.addEventListener('mousemove', function (e) {
      ...
      brandsCircles.forEach(function (circle, index) {
        ...
        var deltaX = (mouseX - circleX) * directions[index].multiplierX * directions[index].x;
        var deltaY = (mouseY - circleY) * directions[index].multiplierY * directions[index].y;
